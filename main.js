...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		if((keyPressed >=97 && keyPressed<=122)|| (keyPressed >=65 && keyPressed<=90)){
			aplhabetkey();
			document.getElementById("d1").innerHTML= "Você pressinou uma tecla alfabeto";
		...
		numberkey();
		document.getElementById("d1").innerHTML= "Você pressinou um número";
	...
	specialkey();
	document.getElementById("d1").innerHTML= "Você pressinou uma tecla especial";
	console.log("special key");
}

else{
	otherkey();
	document.getElementById("d1").innerHTML="Você pressionou um símbolo pressinou um símoblo ou outra tecla";
